...
const createInstallation = async ({ id_cliente, direccion, nombre, localidad, puntos_control, image}) => {
    const res = await dbQuery(installationQueries.createInstallation, [id_cliente, direccion, nombre, localidad, puntos_control, image]);
    return res.rows[0];
};
